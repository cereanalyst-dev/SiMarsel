...
export const ImportExportButtons = ({ platform, onImported }: Props) => {
  ...
  return (
    <div className="flex items-center gap-2">
      <label
        className={cn(
          'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] cursor-pointer transition-all',
      ...
      <button
        ...
        disabled={exporting}
        className={cn(
          'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all',
          'bg-slate-50 text-slate-700 hover:bg-slate-100 border border-slate-100',
