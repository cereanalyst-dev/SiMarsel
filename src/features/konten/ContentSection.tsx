            ...
            {(['video', 'carousel', 'single_post'] as ContentType[]).map((t) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all',
    ...
    <td className="p-0 align-middle border-r border-slate-100">
      <div className="w-full p-1.5">
        <button
          ...
          onClick={() => setOpen((o) => !o)}
          className={cn(
            'w-full px-2.5 py-1.5 inline-flex items-center justify-between gap-1.5 rounded-lg text-[10px] font-black uppercase tracking-[0.2em] transition-all',
            'border',
            tone
...
function DropdownOption({
  ...
  return (
    <button
      ...
      className={cn(
        'w-full px-2.5 py-1.5 my-0.5 inline-flex items-center justify-between gap-2 rounded-lg text-[10px] font-black uppercase tracking-[0.2em] text-left transition-all',
        tone
