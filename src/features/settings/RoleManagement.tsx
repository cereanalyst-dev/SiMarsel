        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-rose-600 hover:bg-rose-700 disabled:bg-slate-300 text-white rounded-xl text-[10px] font-black uppercase tracking-widest"
            >
                ...
                <tr key={row.user_id} className="border-b border-slate-50 hover:bg-slate-50/40">
                  ...
                  <td className="py-3 px-3">
                    <select
                      ...
                      className="px-2 py-1 bg-white border border-slate-200 rounded-md text-[10px] font-black uppercase tracking-widest outline-none"
                    >
                      {ROLE_OPTIONS.map((r) => <option key={r} value={r}>{ROLE_LABELS[r]}</option>)}
                    </select>
                  </td>
