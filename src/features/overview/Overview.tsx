  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        <SummaryCard icon={DollarSign} color="indigo" title="Total Revenue" value={formatCurrency(stats.totalRevenue)} subtitle="Sum revenue" />
        <SummaryCard icon={ShoppingBag} color="emerald" title="Total Transaksi" value={formatNumber(stats.totalTransactions)} subtitle="Jumlah baris transaksi" />
        ...
        <SummaryCard icon={TrendingUp} color="amber" title="AOV" value={formatCurrency(stats.aov)} subtitle="Revenue / Total Transaksi" />
        ...
        <SummaryCard icon={UserCheck} color="rose" title="User Repeat Order" value={formatNumber(stats.totalRepeatOrderUsers)} subtitle="Email dengan ≥ 2 trx_id" />
      </div>
