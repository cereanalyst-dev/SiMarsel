  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap">
        <Badge variant={slide.badge} className="!text-sm md:!text-base !px-3 !py-1.5">
          {slide.label}
        </Badge>
                  ...
                  <div key={p.name} className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline justify-between gap-2 mb-1">
                        <p className="text-sm md:text-base font-bold leading-tight line-clamp-2 break-words">
                          {p.name}
                        </p>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold tabular-nums text-nb-black/60 w-10 text-right">
              ...
              {sortedPromo.map((e, i) => {
                ...
                return (
                  <div key={e.code} className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline justify-between gap-2 mb-1">
                        <p className="font-display text-sm md:text-base leading-tight truncate" title={e.code}>
                          {e.code}
                        </p>
                        <span className="text-sm md:text-base font-display tabular-nums flex-shrink-0">
